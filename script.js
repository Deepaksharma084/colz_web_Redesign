document.addEventListener("DOMContentLoaded", function () {
    ...
    tl3.from(a, {
        opacity: 0,
        x: 30,
        stagger: 0.04,//h1's ko bari bari chalayega
    })
...
var icon1 = document.querySelector("#keyPeople #imagePart #first-img-div i")
...
var icon2 = document.querySelector("#keyPeople #imagePart #second-img-div i")
